...
def preforeclosure_to_dict(pf):
    return {
        ...
        "last_scanned": pf.last_scanned.isoformat() + "Z" if pf.last_scanned else None,
        ...
        "archived_at": pf.archived_at.isoformat() + "Z" if pf.archived_at else None,
        "linked_deal_id": pf.linked_deal_id,
        "date_added": pf.date_added.isoformat() + "Z" if pf.date_added else None,
